...
class Config:
    ...
    # Шаг симуляции (с) = data.dt / SIM_SUBSTEPS. Меньший шаг делает симуляцию
    # устойчивой и для агрессивных настроек (иначе при большом Kp контур
    # численно «раскачивается»); больше — медленнее и больше точек на графике.
    SIM_SUBSTEPS = 10                # число подшагов дискретизации симуляции
